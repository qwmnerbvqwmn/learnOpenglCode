...
int main()
{
	...
	// ------------------------------------
	Shader ourShader("7.4.Light.vs", "7.4.Light.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 projection = glm::perspective(glm::radians(Light.Zoom), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
...
void scroll_callback(GLFWwindow * window, double xoffset, double yoffset)
{
	Light.ProcessMouseScroll(yoffset);
}