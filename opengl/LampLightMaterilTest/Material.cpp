...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightingShader.setVec3("material.specular", 0.508273f, 0.508273f, 0.508273f); // specular lighting doesn't have full effect on this object's material
		lightingShader.setFloat("material.shininess", 128 * 0.4f);
